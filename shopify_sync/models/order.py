...
class Order(ShopifyDatedResourceModel):
    ...
    client_details = models.JSONField(
        encoder=ShopifyDjangoJSONEncoder, null=True)
    ...
    discount_codes = models.JSONField(
        default=empty_list, encoder=ShopifyDjangoJSONEncoder, null=True)
    ...
    note_attributes = models.JSONField(
        encoder=ShopifyDjangoJSONEncoder, null=True)
    ...
    shipping_lines = models.JSONField(
    ...
    def calculate_refund(self, line_items=None):
        ...
        for line in line_items:
            refund_lines.append(
                {"line_item_id": line.id, "quantity": line.quantity})
