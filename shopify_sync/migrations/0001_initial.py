    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('multipass_identified', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.customer')),
            ],
            bases=(shopify_sync.models.base.ChangedFields, models.Model),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.JSONField(
                    encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder, null=True)),
                ...
                ('discount_codes', models.JSONField(default=shopify_sync.encoders.empty_list,
                 encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder, null=True)),
                ('email', models.EmailField(max_length=254)),
                ('financial_status', models.CharField(max_length=32)),
                ('fulfillment_status', models.CharField(max_length=32, null=True)),
                ('fulfillments', models.JSONField(default=shopify_sync.encoders.empty_list,
                 encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder, null=True)),
                ...
                ('shipping_address', models.JSONField(
                    encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder, null=True)),
                ('shipping_lines', models.JSONField(default=shopify_sync.encoders.empty_list,
                 encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder)),
                ('source_name', models.CharField(max_length=32)),
                ('tax_lines', models.JSONField(default=shopify_sync.encoders.empty_list,
                 encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner_resource', models.CharField(choices=[
                 ('shop', 'Shop'), ('product', 'Product')], default='shop', max_length=32)),
                ('value', models.TextField()),
                ('value_type', models.CharField(choices=[
                 ('string', 'String'), ('integer', 'Integer')], default='string', max_length=32)),
                ('product', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.product')),
                ('session', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.session')),
            ],
            bases=(shopify_sync.models.base.ChangedFields, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('properties', models.JSONField(default=shopify_sync.encoders.empty_list,
                 encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier_service_type', models.CharField(choices=[
                 ('api', 'API'), ('legacy', 'Legacy')], default='api', max_length=16)),
                ('name', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('money_in_emails_format', models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published_scope', models.CharField(
                    default='global', max_length=16)),
                ('rules', models.JSONField(default=shopify_sync.encoders.empty_list,
                 encoder=shopify_sync.encoders.ShopifyDjangoJSONEncoder)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_management', models.CharField(
                    default='blank', max_length=32, null=True)),
                ('inventory_policy', models.CharField(
                    default='deny', max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('province_code_of_origin', models.CharField(
                ...
                ('session', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.session')),
                ('variant', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                 related_name='inventory_item', to='shopify_sync.variant')),
            ],
            bases=(shopify_sync.models.base.ChangedFields, models.Model),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='inventory_levels', to='shopify_sync.inventoryitem')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='inventory_levels', to='shopify_sync.location')),
                ('session', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='shopify_sync.session')),
            ],
            options={
