...
- [ ] 3. Implement Products API endpoints
  ...
  - [ ] 3.3 Create product detail view
  ...
  - [ ] 3.4 Create product sync endpoint
...
- [ ] 4. Implement Inventory API endpoints
  ...
  - [ ] 4.3 Create inventory reconcile endpoint
...
- [ ] 8. Implement API client services
  - [ ] 8.1 Create products service
...
- [ ] 9. Implement Dashboard view
  - [ ] 9.1 Create dashboard route at `/app`
  ...
  - [ ] 9.2 Add loading and error states
...
- [ ] 10. Implement Products List view
  - [ ] 10.1 Create products list route at `/app/products`
...
- [ ] 11. Implement Product Detail view
  - [ ] 11.1 Create product detail route at `/app/products/$id`
...
- [ ] 12. Implement Inventory view
  - [ ] 12.1 Create inventory route at `/app/inventory`
...
- [ ] 13. Implement Jobs view
  - [ ] 13.1 Create jobs list route at `/app/jobs`
  ...
  - [ ] 13.2 Add status badges and progress bars
  ...
  - [ ] 13.4 Add job detail navigation
    - Navigate to job detail on row click
    - _Requirements: 11.7_
  
  - [ ] 13.5 Add auto-refresh for active jobs
...
- [ ] 14. Implement Settings view
  - [ ] 14.1 Create settings route at `/app/settings`
...
- [ ] 20. Verify coexistence with existing UI
  ...
  - [ ] 20.4 Verify no backend modifications
