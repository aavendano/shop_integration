...
def test_product_import():
    ...
    # Check for CSV file
    csv_path = Path(
        '/home/alejandro/shop-app/shop_integration/nal-product-attributes-main-preselect-minimal.csv')
    ...
    config_path = Path(
        '/home/alejandro/shop-app/shop_integration/products_parsing/config/providers/nalpac.json')
    ...
    try:
        ...
        record_count = len(list(records)) if hasattr(
            records, '__len__') else 'unknown'
